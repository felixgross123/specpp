...
public class FelixNewPlaceComposer1<I extends AdvancedComposition<Place>> extends AbstractComposer<Place, I, CollectionOfPlaces> {
    ...
    public FelixNewPlaceComposer1(I composition) {
    ...
    protected void candidateAccepted(Place candidate) {
        ...
        int candidateLevel = Math.max(candidate.preset().size(), candidate.postset().size());
